...
public enum SerializableType {
	...
	UNSUPPORTED(null, 'U') {
		@Override
		public Object parseFromString(String string) { return null; }
	},
	
	STRING(String.class, 'T') {
		@Override
		public Object parseFromString(String string) { return string; }
	},
	
	// Symbols are taken from: http://www.rgagnon.com/javadetails/java-0286.html
	VOID(Void.class, 'V'){
		@Override
		public Object parseFromString(String string) { return null; }
	},
	BOOLEAN(Boolean.class, 'Z'){
		@Override
		public Object parseFromString(String string) { return Boolean.parseBoolean(string); }
	},
	BYTE(Byte.class, 'B'){
		@Override
		public Object parseFromString(String string) { return Byte.parseByte(string); }
	},
	CHARACTER(Character.class, 'C'){
		@Override
		public Object parseFromString(String string) { return string.charAt(0); }
	},
	SHORT(Short.class, 'S'){
		@Override
		public Object parseFromString(String string) { return Short.parseShort(string); }
	},
	INTEGER(Integer.class, 'I'){
		@Override
		public Object parseFromString(String string) { return Integer.parseInt(string); }
	},
	LONG(Long.class, 'J'){
		@Override
		public Object parseFromString(String string) { return Long.parseLong(string); }
	},
	FLOAT(Float.class, 'F'){
		@Override
		public Object parseFromString(String string) { return Float.parseFloat(string); }
	},
	DOUBLE(Double.class, 'D'){
		@Override
		public Object parseFromString(String string) { return Double.parseDouble(string); }
	};
	...
	public Class<?> getNativeClass() { return cls; }
